...
## 1️⃣ Day-01-06_08_2026: Node.js Foundation

### 📄 Code (`Day-01-06_08_2026/app.js`)
```javascript
...
## 2️⃣ Day-02-07_08_2026: Core Modules & Module Systems

### 📄 Code File 1: `Day-02-07_08_2026/commonJs/app.js`
```javascript
...
## 3️⃣ Day-03-10_08_2026: Native HTTP Server & Manual Routing

### 📄 Code (`Day-03-10_08_2026/app.js`)
```javascript
...
## 4️⃣ Day-04-13_08_2026: Introduction to Express Framework

### 📄 Code (`Day-04-13_08_2026/app.js`)
```javascript
...
## 5️⃣ Day-05-14_08_2026: Streams & HTTP POST Body Handling

### 📄 Code (`Day-05-14_08_2026/app.js`)
```javascript
1: const http = require('http');
2: 
3: const server = http.createServer((req, res) => {
...
## 6️⃣ Day-06-17_08_2026: Express Route & Query Parameters Deep Dive

### 📄 Code (`Day-06-17_08_2026/index.js`)
```javascript
1: const express = require('express');
2: const app = express();
3: const packages = require('./data/tour');
...
## 7️⃣ Day-07-20_08_2026: MVC Architecture Foundations
...
## 8️⃣ Day-08-21_08_2026: Full RESTful CRUD API under MVC

### 📄 Model Operations (`Day-08-21_08_2026/model/tourModel.js`)
```javascript
// CREATE
1: const save = (tour) => {
...
## 9️⃣ Day-09-28_08_2026: Multi-Resource MVC System (Tours + Users)

### 📄 Main App Entry (`Day-09-28_08_2026/index.js`)
```javascript
1: const express = require('express');
2: const app = express();
3: 
